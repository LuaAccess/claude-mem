...
// HARDENED: Removed AWS_*, GCP, and Vertex credentials from subprocess env propagation.
// These were previously passed to worker subprocesses, creating risk if a subprocess
// was compromised. Re-add specific vars here only if you use Bedrock/Vertex providers.
// To re-enable Bedrock: add 'AWS_REGION', 'AWS_ACCESS_KEY_ID', 'AWS_SECRET_ACCESS_KEY', 'AWS_SESSION_TOKEN'
// To re-enable Vertex: add 'ANTHROPIC_VERTEX_PROJECT_ID', 'CLOUD_ML_REGION', 'GOOGLE_APPLICATION_CREDENTIALS'
export const ENV_PRESERVE = new Set([
  'CLAUDE_CODE_OAUTH_TOKEN',
  'CLAUDE_CODE_GIT_BASH_PATH',
  // Cloud provider vars removed — add back only if using Bedrock or Vertex:
